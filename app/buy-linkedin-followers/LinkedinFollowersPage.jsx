...
import lnFollowersData from "../constant/linkedin/lnFollowersData.json";
      ...
      <div className="w-[90%] xl:w-[80%] m-auto ">
        <div className="py-10 w-full flex flex-col gap-8 justify-center items-center">
          <h1 className="text-center text-3xl md:text-4xl text-[#0d1821] font-bold">
            Buy Real <span className="text-[#0A66C2]">LinkedIn</span> Followers
          </h1>
          <PackageSection
            packageData={lnFollowersData}
            serviceName={"Buy Linkedin Followers"}
